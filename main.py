...
toxic_comments_train = toxic_comments_classifier.ToxicComments(glove_model, 'train', 80)
toxic_comments_train.load_toxic_comments('.\\all\\train.csv')

toxic_comments_test = toxic_comments_classifier.ToxicComments(glove_model, 'test', 80)
